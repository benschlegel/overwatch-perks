	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
	{
		variants: {
			variant: {
				...
				linkHover1:
					'!p-0 !h-auto relative after:absolute after:bg-primary-foreground hover:text-primary-foreground after:bottom-0 after:h-[1.5px] after:w-full after:origin-bottom-left after:scale-x-100 hover:after:origin-bottom-right hover:after:scale-x-0 after:transition-transform after:ease-in-out transition-colors duration-300 after:duration-300',
				linkHover2:
...
export { Button as EnhancedButton, buttonVariants };
