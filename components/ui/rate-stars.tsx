...
export default function StarRating({ onChange, className }: StarRatingProps = {}) {
	...
	return (
		<div className={cn('flex items-center space-x-2', className)}>
			<div
				ref={containerRef}
				className="flex space-x-1 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-primary-foreground focus-visible:ring-offset-1 rounded-md p-2 ml-[-0.5rem]"
				role="slider"
				tabIndex={0}
				aria-label="Rating"
				aria-valuemin={0}
