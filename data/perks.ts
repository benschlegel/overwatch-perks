...
export const PERKS: Perk[] = [
	...
	},
	{
		...
		heroId: 'junker-queen',
		name: 'Deep Wounds',
		description: 'Scattergun hits extend your wound durations on those enemies by 0.5 seconds.',
		perkType: 'major',
		perkIndex: 0,
	},
	...
	},
	{
		...
		heroId: 'roadhog',
		name: 'Hog Toss',
		description: "Pig Pen's throw range is increased by 50% and damage is increased by 25%.",
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'sigma',
		name: 'Massive Impact',
		description: "Accretion's knockdown duration increases up to 3 seconds based on travel distance.",
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	{ id: 39, heroId: 'sigma', name: 'Levitation', description: 'Activate and hold Double Jump briefly to levitate upward.', perkType: 'major', perkIndex: 1 },
	{
		...
		heroId: 'winston',
		name: 'Short Circuit',
		description: 'Tesla Cannon deals 50% more damage to deployable objects.',
		perkType: 'minor',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		description: 'Fully charged Secondary Fire hits bounce up to 2 additional targets.',
		perkType: 'major',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		description: 'Reactivating Adaptive Shield reduces its cooldown by 1.5 seconds per ally affected and the transfer cost is reduced by 50%.',
		perkType: 'major',
		perkIndex: 1,
	},
	...
	},
	{
		...
		heroId: 'cassidy',
		name: 'Past Noon',
		description: 'Deadeye refunds 40% Ultimate charge if it fully expires.',
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		description: "During Duplicate, your clone's first ultimate extends Duplicate's duration by 3 seconds.",
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'genji',
		name: 'Blade Twisting',
		description: 'Swift Strike deals 25 additional damage over time when used shortly after an elimination (within 10s).',
		perkType: 'major',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'hanzo',
		name: 'Scatter Arrows',
		description: 'Storm Arrows split into 3 new projectiles on their first ricochet and bounce 2 extra times.',
		perkType: 'minor',
		perkIndex: 1,
	},
	{
		...
		heroId: 'hanzo',
		name: 'Dragon Fury',
		description: 'After hitting an enemy with primary fire, gain 25% attack speed for 1 second.',
		perkType: 'major',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'junkrat',
		name: 'Frag Cannon',
		description: "Frag Launcher's projectile speed is increased by 40%, but its max ammo is reduced by 1.",
		perkType: 'major',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'mei',
		name: 'Permafrost',
		description: "Ice Wall's duration is increased by 2 seconds.",
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'pharah',
		name: 'Helix Shields',
		description: 'Convert 125 health to shields.',
		perkType: 'minor',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		description: 'Leaving Wraith form grants 40% additional lifesteal for 3 seconds',
		perkType: 'major',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'soldier-76',
		name: 'Stim Pack',
		description: 'Biotic Field can be used as a Stim Pack, increasing attack speed and reload speed by 30% while being unhealable for 4 seconds.',
		perkType: 'major',
		perkIndex: 1,
	},
	{
		...
		heroId: 'sombra',
		name: 'Viral Efficacy',
		description: "Virus' cooldown is reduced by 3 seconds when an enemy affected by Virus is eliminated",
		perkType: 'minor',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'sombra',
		name: 'White Hat',
		description: 'Hack can be used on allies to restore 100 health over 2 seconds.',
		perkType: 'major',
		perkIndex: 0,
	},
	{
		...
		heroId: 'sombra',
		name: 'Stack Overflow',
		description: "Hack's silence duration is increased by 100%, but its range is decreased by 15%.",
		perkType: 'major',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'torbjorn',
		name: 'Craftsman',
		description: "Forge Hammer can restore armor health to allies. Turret gains 25 HP and Turret repair's heal is increased by 25%.",
		perkType: 'minor',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'widowmaker',
		name: 'Deadly Deux',
		description: 'Venom Mine gains 50% increased damage and a second charge, enabling 2 active mines at a time.',
		perkType: 'major',
		perkIndex: 1,
	},
	/**
	 ...
	 */
	{
		...
		heroId: 'ana',
		name: 'Groggy',
		description: 'Enemies waking up from Sleep Dart are slowed for 2 seconds',
		perkType: 'minor',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		description: 'After placing Amplification Matrix, your Shoulder Turret periodically fires up to 12 shots at allies, each restoring 30 health.',
		perkType: 'minor',
		perkIndex: 1,
	},
	{
		...
		heroId: 'baptiste',
		name: 'Assault Burst',
		description: 'Regenerative Burst grants Baptiste 30% attack speed for 4 seconds, but no longer instantly heals',
		perkType: 'major',
		perkIndex: 0,
	},
	{
	...
	},
	{
		...
		heroId: 'juno',
		name: 'Re-Boots',
		description: 'Activating Glide Boost resets Double Jump. Additionally, it increases the duration of Glide Boost by 25%.',
		perkType: 'major',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'kiriko',
		name: 'Shuffling',
		description: 'Swift Step can be used again within 4 seconds of its initial cast.',
		perkType: 'major',
		perkIndex: 0,
	},
	{
		...
		heroId: 'kiriko',
		name: 'Foxtrot',
		description: 'Protection Suzu grants 40% movement speed to allies for 2 seconds.',
		perkType: 'major',
		perkIndex: 1,
	},
	{
	...
	},
	{
		...
		heroId: 'lucio',
		name: "Groovin'",
		description: 'Regenerate 4 ammo per second while wall riding.',
		perkType: 'minor',
		perkIndex: 1,
	},
	{
